...
#-------------------------------------------------------------------------------
# from julia_charmap.h, used by julia_chartransform
...
# FIXME: Does this belong here? It should probably belong to JuliaSyntax? It
# can change with Julia VERSION, after all.
"""
